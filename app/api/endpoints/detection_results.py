...
from app.schemas.detection_result import DetectionResult as DetectionResultSchema, DetectionResultCreate, DetectionResultUpdate
...
@router.get("/", response_model=List[DetectionResultSchema], summary="获取检测结果列表", description="获取指定病例的检测结果列表")
...
@router.get("/{result_id}", response_model=DetectionResultSchema, summary="获取检测结果详情", description="获取指定检测结果的详细信息")
...
@router.put("/{result_id}", response_model=DetectionResultSchema, summary="更新检测结果", description="更新指定检测结果的信息")
...
@router.delete("/{result_id}", response_model=DetectionResultSchema, summary="删除检测结果", description="删除指定检测结果")
