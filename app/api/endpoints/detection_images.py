...
from app.schemas.detection_image import DetectionImage as DetectionImageSchema
from app.utils.cos import delete_file_from_cos
...
@router.get("/", response_model=List[DetectionImageSchema], summary="获取检测图像列表",
            description="获取指定检测结果的图像列表")
...
@router.get("/{image_id}", response_model=DetectionImageSchema, summary="获取检测图像详情",
            description="获取指定检测图像的详细信息")
...
@router.delete("/{image_id}", response_model=DetectionImageSchema, summary="删除检测图像",
               description="删除指定检测图像")
def delete_detection_image(
    ...
    # Delete the file
    delete_file_from_cos(detection_image.file_path)
